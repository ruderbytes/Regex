 ...
 */
/*
.(dot) digunakan untuk mencari semua karakter.
*/
public class KarakterApapun {
    public static void main(String[] args) {
		String str = "Ahmad Rosid AK 12345 PA (0728) 555-121 Yogyakarta ocittwo@gmail.com 412-555-1234";
//		String str2 = "1Z aaa {{{ [[[";
		checkRegex(".", str);
	}
